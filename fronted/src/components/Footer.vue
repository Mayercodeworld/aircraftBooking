        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto">
                <ul class="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                    ...
                    <router-link to="/" class="text-gray-800 hover:text-black">首页</router-link>
                    <router-link to="/about" class="text-gray-800 hover:text-black">关于</router-link>
                ...
                <div class="flex space-x-10 justify-center items-center mb-14">
                    <div class="icon-container">
                        <div class=" block text-gray-900 transition-all duration-500 hover:text-indigo-600 ">
